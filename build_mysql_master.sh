...
cmake \
-DCMAKE_INSTALL_PREFIX=/opt/server/database/mysql_master \
-DSYSCONFDIR=/opt/server/database/mysql_master \
-DMYSQL_UNIX_ADDR=/opt/server/database/mysql_master/tmp/mysql.sock \
-DMYSQL_TCP_PORT=3306 \
-DMYSQL_DATADIR=/opt/server/database/mysql_master/data \
...
cd /opt/server/database/mysql_master
chown -R mysql .
chgrp -R mysql .
